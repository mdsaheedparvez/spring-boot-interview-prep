...
public class SearchInSortedRotatedArray {
	/*
	 * Code Testcase Testcase Test Result 33. Search in Rotated Sorted Array Solved
	 * Medium Topics premium lock icon Companies There is an integer array nums
	...
	public static void main(String[] args) {
		...
		int search = searchInSortedRotatedArray.search(nums, 6);
