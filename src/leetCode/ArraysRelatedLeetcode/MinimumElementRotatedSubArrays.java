...
public class MinimumElementRotatedSubArrays {
	/*
	 * 153. Find Minimum in Rotated Sorted Array Solved Medium Topics premium lock
	 * icon Companies Hint Suppose an array of length n sorted in ascending order is
	 ...
	 * nums are unique. nums is sorted and rotated between 1 and n times.
	 */

	public static void main(String[] args) {
		int[] nums = { 1, 2, 3, 4, 1, 2 };

		int min = MinimumElementRotatedSubArrays.findMinElement(nums);
